...
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473852732_4685968-a5f955b792bd453e.png)
...
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473852753_4685968-8410e7935aa8b28e.png)
...
![线程池相关类图](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473852909_4685968-eaaaf8fd88497757.png)
...
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473852906_4685968-3b4a8e8c1408f892.png)
...
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473852819_4685968-8cd91f3c6eada9de.png)
其中使用了 LinkedBlockingQueue, 但是没有设置上限!!!,堆积过多任务!!!

下面介绍`LinkedBlockingQueue`的构造方法
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473852910_4685968-fce261dbe30def71.png)
...
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473852797_4685968-d2025287a82add95.png)
...
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561474494512_5D0DD7BCB7171E9002EAD3AEF42149E6 "图片标题") 

池中保持nThreads个线程，最多也只有nThreads个线程，多余的任务也在队列中排队。 
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561476084467_4A47A0DB6E60853DEDFCFDF08A5CA249 "图片标题") 

![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561476102425_FB5C81ED3A220004B71069645F112867 "图片标题") 
线程数固定且线程不超时
...
如图为排查底层公共缓存调用出错时的截图
![有意义的线程命名](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473852749_4685968-85502533906c33f2.png)
...
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473852809_4685968-ac7fac2c6b332daf.png)


在`ThreadPoolExecutor`中提供了四个公开的内部静态类
● AbortPolicy  - **默认** 
丢弃任务并抛出`RejectedExecutionException`
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473852986_4685968-dcf8126c187d4bfa.png)

● DiscardPolicy - **不推荐**
丢弃任务,但不拋异常.
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473852956_4685968-d5195020e347d8eb.png)

● DiscardOldestPolicy
抛弃队列中等待最久的任务,然后把当前任务加入队列中.
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473853806_4685968-d3a36b90211138f4.png)

● CallerRunsPolicy
调用任务的run()方法绕过线程池直接执行.
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473852908_4685968-c06a04d6ce30de97.png)


根据之前实现的线程工厂和拒绝策略,线程池的相关代码实现如下
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473854161_4685968-8b1c576213bea3ca.png)
...
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473852842_4685968-8dc7d0eacb458f2e.png)

![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473852717_4685968-813376a9826e24c6.png)

- 000-1111111111111111111111111;
类似于子网掩码,用于与运算;
得到左边3位,还是右边29位
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473853309_4685968-6c7f894116972a2f.png)
...
该状态表 线程池能接受新任务
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473852713_4685968-e838c56b99544e93.png)


- 000 - 0000000000000000000000000(十进制: 0);
此状态不再接受新任务,但可继续执行队列中的任务
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473853025_4685968-d3447678b77c851f.png)

- 001 - 00000000000000000000000000(十进制: 536,870， 912);
此状态全面拒绝,并中断正在处理的任务
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473852872_4685968-6c399a28de0f375b.png)

- 010 - 00000000000000000000000000.(十进制值: 1, 073, 741, 824);
该状态表 所有任务已经被终止
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473852814_4685968-e1341ccae3d73473.png)

- 101 - 000000000000000000000000000(十进制值: 1, 610,612, 736)
该状态表 已清理完现场
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473852713_4685968-2b83ef2a0f28b570.png)

与运算,比如 001 - 000000000000000000000100011 表 67个工作线程;
掩码取反: 111 - 00000000000000000000000.,即得到左边3位001;
表示线程池当前处于**STOP**状态
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473852956_4685968-0d9b0884abe8e1c1.png)

同理掩码 000 - 11111111111111111111,得到右边29位,即工作线程数
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473852768_4685968-90063b2134c89772.png)

把左3位与右29位或运算,合并成一个值
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473852959_4685968-858df4ebcb91a84e.png)
...
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473853220_4685968-28604fb5da1922e4.png)
...
- 第2处,这样的表达式不利于阅读,应如是
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473852785_4685968-086e9d5f9da2afd4.png)
...
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473853232_4685968-c9352782c56c3d67.png)
...
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561476436402_10FB15C77258A991B0028080A64FB42D "图片标题") 
它们都是某种线程池,可以控制线程创建,释放,并通过某种策略尝试复用线程去执行任务的一个管理框架

,因此最终所有线程池的构造函数都调用了Java5后推出的ThreadPoolExecutor的如下构造函数                        
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473852810_4685968-bf41009597986058.png)

## Java默认提供的线程池
Java中的线程池是运用场景最多的并发框架,几乎所有需要异步或并发执行任务的程序都可以使用线程池
![](https://uploadfiles.nowcoder.com/files/20190625/5088755_1561473853075_4685968-4f18b5e96eb1d930.png)
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473852989_4685968-b7ec59a800442b26.png)
...
```
# 线程池的实现原理
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473852674_4685968-fa16ddf5e4094e75.png)
...
private void addWor](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/4685968-77abdc7bff21cca6.png)
...
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473853633_4685968-33f514577e97dc35.png)




`worker` 中的线程 `start` 后，其 `run` 方法会调用 `runWorker `
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473852880_4685968-a009bc02a224dce2.png)
继续往下看 `runWorker`
```
...
```
看看 `getTask() `
![](https://typoraimgbed.oss-cn-hangzhou.aliyuncs.com/img/5088755_1561473852780_4685968-5e94773193d9cf49.png)
```
// 此方法有三种可能
